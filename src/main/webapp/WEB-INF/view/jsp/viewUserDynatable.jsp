...
//                    $('#securityContext').html('');
         ...
         /*         table="<table><tr><th>Name</th><th>Address</th><th>Phone</th></tr>"; */
                for (i = 0; i <= value.data.length - 1; i++) {
                 table += "<tr><td>" + value.data[i].lastName+ "</td><td>" +
              value.data[i].firstName + "</td><td>"+
              value.data[i].password + "</td></tr>"+
              value.data[i].id + "</td></tr>"+
              value.data[i].age + "</td></tr>"+
              value.data[i].email + "</td></tr>"+
              value.data[i].status + "</td></tr>";
               }
               document.getElementById("tableIdToFill").innerHTML = table+"</table>"; 
              ...
              xhttp.open("GET", "./viewUsers.do", true);
              xhttp.send();
            }
